...
import { Phone, Hammer, Flame, Beer, HardHat, Truck, Clock, ShieldCheck } from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-stone-100">
      ...
      <nav className="fixed w-full z-50 bg-stone-100/90 backdrop-blur-md border-b-4 border-stone-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="font-serif text-2xl font-black text-stone-900 uppercase tracking-tighter">
            Cihly s duší <span className="text-orange-700">Pardubice</span>
          </div>
          <a 
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-6xl lg:text-8xl font-serif font-black leading-none mb-8 text-stone-900 uppercase">
                Léto volá.<br />
                <span className="text-orange-700">Postavte to vlastníma rukama.</span>
              </h1>
              <p className="text-xl text-stone-700 mb-10 leading-relaxed font-medium">
                Znáte ten pocit zadostiučinění, když vám pod rukama roste dílo z cihel, které mají historii? 
                Tvrdá práce, vůně malty a zasloužený odpočinek u vlastního grilu. To si nekoupíte, to si musíte odpracovat.
              </p>
            ...
            >
              <Image
                src="https://picsum.photos/seed/bricklaying/800/1200"
              ...
              <div className="absolute bottom-0 left-0 p-8">
                <div className="bg-orange-700 px-6 py-4 border-l-4 border-white inline-block">
                  <p className="text-xl font-black text-white uppercase tracking-wider">Poctivá práce</p>
                  <p className="text-sm font-bold text-orange-200 uppercase">Výsledek, který přetrvá</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-xl text-stone-700 font-medium">
              Nejde o to mít to hotové hned. Jde o ten proces. O to vzít do ruky materiál, 
              který už něco zažil, a dát mu nový smysl.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-2xl font-black text-stone-900 mb-4 uppercase">{benefit.title}</h3>
                <p className="text-stone-700 leading-relaxed font-medium text-lg">{benefit.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-stone-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Zahradní gril a udírna", img: "brickgrill", desc: "Kde se peče maso a vypráví historky." },
              { title: "Vyvýšené záhony", img: "raisedbed", desc: "Poctivá práce pro vaši zahradu." },
              { title: "Zídky a ploty", img: "brickwall", desc: "Pevná hranice vašeho království." },
              { title: "Dlažba a cestičky", img: "brickpath", desc: "Krok za krokem po staré klasice." }
            ].map((item, i) => (
              <motion.div 
                key={i}
                initial={{ opacity: 0, scale: 0.95 }}
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 p-8 w-full">
                  <h3 className="text-2xl font-black text-white mb-2 uppercase leading-tight">{item.title}</h3>
                  <p className="text-stone-300 font-medium mb-4 text-sm">{item.desc}</p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-stone-400 mb-10 font-medium">
                Víme, že chcete stavět, ne ztrácet čas. Naše cihly jsou pečlivě tříděné, očištěné od hrubé malty a připravené k okamžitému odběru v Pardubicích.
              </p>
              
              <ul className="space-y-6">
                {[
                  { icon: ShieldCheck, text: "Pečlivě tříděné a očištěné od hrubé malty" },
                  { icon: Truck, text: "Možnost nakládky ještěrkou přímo na váš vozík" },
                  { icon: HardHat, text: "Připraveno na paletách k okamžitému odběru" }
                ].map((item, i) => (
                  <li key={i} className="flex items-center gap-6 bg-stone-800 p-4 border-l-4 border-orange-600">
                    <div className="text-orange-500">
                      <item.icon className="w-8 h-8" />
                    </div>
                    <div>
                      <span className="text-stone-200 font-bold text-lg uppercase tracking-wide">{item.text}</span>
                    </div>
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-orange-600 p-10 md:p-14 border-8 border-stone-950 shadow-[16px_16px_0px_0px_rgba(12,10,9,1)]">
              <h3 className="text-3xl font-black text-stone-950 mb-6 uppercase">Máte vozík? Přijeďte si.</h3>
              <p className="text-stone-900 font-bold text-lg mb-10">
                Pro aktuální skladové zásoby nám rovnou zavolejte. Domluvíme detaily a můžete začít míchat maltu.
              </p>
              <a 
                href="tel:+420777123456" 
              ...
              <p className="text-lg font-bold text-center text-stone-900 uppercase tracking-widest">
      ...
      <section className="py-32 bg-stone-800 text-white text-center border-t-8 border-stone-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-2xl text-stone-300 mb-12 font-medium">
            Zásoby starých cihel mizí. Co se zbourá, to se prodá. Zajistěte si materiál pro svůj projekt ještě dnes a o víkendu můžete začít.
          </p>
          <a 
            href="tel:+420777123456" 
      ...
      <footer className="bg-stone-950 py-12 text-center text-stone-500 font-bold uppercase tracking-widest">
        <p className="mb-4">© {new Date().getFullYear()} Prodej použitých cihel Pardubice.</p>
        <p>Volat můžete denně: <a href="tel:+420777123456" className="text-orange-600 hover:text-orange-400 text-xl ml-2">+420 777 123 456</a></p>
      </footer>
    </main>
  );
}
